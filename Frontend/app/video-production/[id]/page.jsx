...
export default function VideoProductionDetailPage() {
    ...
    const [isAdmin, setIsAdmin] = useState(false); // ✅ Added state to track if admin is logged in
...
>
                        ...
                        {/* ✅ ONLY RENDER ADD CARDS IF ADMIN IS LOGGED IN */}
...
/> Eta video production id page a gia fashion a jemon change korechili orom change kore dis
                            </div>
                        ))}
